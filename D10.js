...
const dice = () => {
  ...
  console.log("random n with a function", numb);
};
...
const splitMe = function (string) {
  ...
  console.log("my split string is:", myStr);
};
...
const deleteOne = function (string, boolean) {
  if (boolean === true) {
    string.charAt(i).shift();
    console.log(string);
  }
};

deleteOne("Elephant", "true");
...
//Il console.log di questo esercizio l'ho messo dopo l'array perché la console mi diceva che non potevo usare l'array prima della sua inizializzazione..
...
//Anche questa funzione l'ho chiamata dopo l'array a cui si riferisce.
...
const onlyTheYears = function () {
  for (let i = 0; i < movies.length; i++) {
    const years = movies[i];
    moviesYears.push(movies.Year);
  }
};
